public class Main {
    public static void main(String[] args) {
       ...
       Human nikolay = new Human("Николай Петров", "1974-08-17", null, null, Gender.Female);
       Human petr = new Human("Петр Петров", "1997-04-23", svetlana, nikolay, Gender.Female);
       Human ivan = new Human("Иван Иванов", "1998-11-10", null, null, Gender.Female);
       Human anna = new Human("Анна Петрова", "2000-05-16", svetlana, nikolay, Gender.Female);
       Human dima = new Human("Дима Иванов", "2020-12-05", anna, ivan, Gender.Female);
       Human egor = new Human("Егор Иванов", "2022-07-12", anna, ivan, Gender.Female);
